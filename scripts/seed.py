...
def seed_database(num_users=3, todos_per_user=5):
    ...
    with app.app_context():
        ...
        print(f'🌱 Seeding database with {num_users} users and {todos_per_user} todos each...')
        ...
        for i in range(num_users):
            ...
            hashed_pw = bcrypt.generate_password_hash('DemoP@ss123').decode('utf-8')
        ...
        print(f'\n🌱 Seeding complete!')
        print(f'   Login with: demo_1@example.com / DemoP@ss123')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--todos', type=int, default=5, help='Todos per user')
